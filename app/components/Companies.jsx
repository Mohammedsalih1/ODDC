  ...
  return (
    <section className="w-full py-16 bg-gray-50" id="insurance">
      <div className="container mx-auto px-4">
        ...
        {/* mobile grid */}
        <div className="md:hidden grid  grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-8">
              <div
              ...
              >
                ...
                <h3 className="text-sm text-center text-black md:text-xl py-3">الشركة المتحدة للتأمين</h3>
              </div>
              <div
              ...
              >
                <Image
                  ...
                  className="object-cover w-full h-full rounded-2xl"
                />
                <h3 className="text-sm md:text-xl text-black pt-2">شركة كهرباء السودان القابضة المحدودة</h3>
              </div>
              <div
              ...
              >
                <Image
                  ...
                  className="object-cover w-full h-full rounded-2xl"
                />
                <h3 className="text-sm md:text-xl text-black pt-2">ديوان الذكاة</h3>
              </div>
              <div
              ...
              >
                ...
                <h3 className="text-sm text-center text-black md:text-xl py-3">البركة للتأمين</h3>
              </div>
        </div>

        {/* Desktop mo Grid */}
        <motion.div initial={{y: 20, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{delay: 0.3, duration: 0.5}} className="hidden md:grid flex-col  text-black gap-6 mt-4">
